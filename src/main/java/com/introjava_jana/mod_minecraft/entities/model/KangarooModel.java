package com.introjava_jana.mod_minecraft.entities.model;// Made with Blockbench 4.1.5
...
public class KangarooModel<K extends TamableAnimal> extends EntityModel {
    ...
    public KangarooModel() {
        ...
        head = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        body = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        body.setRotationPoint(0.0F, 18.5F, 2.0F);


        ModelRenderer cube_r1 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        ModelRenderer cube_r2 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        right_leg = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r3 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r4 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        left_leg = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r5 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        tail = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        tail.setRotationPoint(-0.5F, 21.0F, -4.0F);


        cube_r6 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r7 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r8 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        cube_r9 = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        right_arm = new ModelRenderer((KangarooModel<TamableAnimal>) this);
        ...
        left_arm = new ModelRenderer((KangarooModel<TamableAnimal>) this);
